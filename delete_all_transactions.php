...
<?php
    ...
    // Select database
        if (mysqli_select_db($dbc, $userdb)) {
            $query = "DELETE FROM $usertable WHERE transaction_id>0;";
...
if (!$continue) {
    die("Unable to read database row ... delete_all_transactions.php");
} 
?>
<body>
	<h1>Money Finance Tracker -- Delete All Transaction Page</h1>
    <p>Error if here!</p>
</body>
</html>